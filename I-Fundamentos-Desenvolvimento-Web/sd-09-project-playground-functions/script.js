...
function compareTrue() {
  const a01 = document.getElementById('a1').value;
  const b01 = document.getElementById('b1').value;
  let resultado = '';
  if (a01 === 'true' && b01 === 'true') {
    resultado = true;
  } else {
    resultado = false;
  }

  document.getElementById('resultado1').innerHTML = `Resultado: <span>${resultado}</span>`;
}

// Desafio 2 - Soma de dois valores
function ex02() {
